...
if ('V:\Development\Website\serverstuff\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('V:\Development\Website\serverstuff\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
